...
ActiveRecord::Schema.define(version: 20200502085443) do
  ...
  create_table "company_financials", force: :cascade do |t|
    ...
    t.index ["date", "company_id"], name: "index_company_financials_on_date_and_company_id", unique: true
  end
  ...
  create_table "investment_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["investment_id", "investor_id"], name: "index_investment_details_on_investment_id_and_investor_id", unique: true
  ...
  create_table "investments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id", "round"], name: "index_investments_on_company_id_and_round", unique: true
  ...
  create_table "investor_fund_details", force: :cascade do |t|
    ...
    t.index ["investor_id", "fund_id"], name: "index_investor_fund_details_on_investor_id_and_fund_id", unique: true
